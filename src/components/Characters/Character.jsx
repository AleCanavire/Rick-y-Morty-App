...
function Character({ character }) {
  ...
  return (
    <div className="character-wrapper" style={active ? {zIndex: 10} : {}}>
      <div className={`character-card-container ${active ? "changeCard" : ""}`}>
        ...
        <div className="character-card-front" style={flip ? {opacity: 0, visibility: "hidden"}: {opacity: 1, visibility: "visible"}}>
          ...
          <div className="change-card" onClick={activePortalGun}/>
        </div>
      ...
      <div className="portal-gun-container" style={active ? {visibility: "visible"} : {}}>
